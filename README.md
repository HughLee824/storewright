...
- [`tools/product-research/shop-scout`](tools/product-research/shop-scout)：基于 SerpApi Google Lens 的商品图片筛选与本地归档工具。
...
```bash
cd tools/product-research/shop-scout
uv sync
cp .env.example .env
uv run shop-scout init
```

完整说明见 [`tools/product-research/shop-scout/README.md`](tools/product-research/shop-scout/README.md)。
