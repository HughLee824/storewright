...
- [StoreWright Catalog Scout](tools/product-research/catalog-scout)：基于 SerpApi Google Lens 的商品图片筛选与本地归档工具，已发布到 [PyPI](https://pypi.org/project/storewright-catalog-scout/)。
...
`storewright-catalog-scout` 已在 PyPI 公开发布，支持 Python 3.12 和 3.13。
...
完整说明见 [Catalog Scout README](tools/product-research/catalog-scout/README.md)，版本记录见 [GitHub Releases](https://github.com/HughLee824/storewright/releases)。
