...
from shop_scout.adapters.taobao import (
    TaobaoAdapter,
...
from shop_scout.domain.models import ProductRef
from shop_scout.extraction.url_normalizer import normalize_http_url
