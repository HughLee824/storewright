...
class ChromeProcessManager:
    ...
    async def start(self, initial_url: str | None = None) -> None:
        ...
        if executable is None:
            raise CatalogScoutError("Chrome/Chromium not found; set CHROME_EXECUTABLE")
        ...
        await self.stop()
        raise CatalogScoutError("Chrome started but its loopback CDP endpoint did not become ready")
